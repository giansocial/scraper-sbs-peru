...
def test_rank_banks_vacio(analyzer):
    ranking = analyzer.rank_banks(pd.DataFrame())
    assert ranking.empty


def test_detect_spread_anomalies_estable(analyzer):
    df = pd.DataFrame({
...
def test_detect_spread_anomalies_spike(analyzer):
